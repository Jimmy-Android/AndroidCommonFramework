...
//        Log.e("shensq", "PreviewPhotosFragmentAdapter  position = " + position + " ,path = " + path + " ,type = " + type);

        final boolean isGif = path.endsWith(Type.GIF) || ((null != type) && type.endsWith(Type.GIF));
        ...
        } else if (Setting.showVideo && null != type && type.contains(Type.VIDEO)) {
