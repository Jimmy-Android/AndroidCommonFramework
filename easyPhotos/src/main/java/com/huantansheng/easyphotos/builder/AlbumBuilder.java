...
import com.huantansheng.easyphotos.enums.PicShape;
...
public class AlbumBuilder {
     ...
     * 是否选择完图片之后接着跳转到裁剪
     *
     * @param autoToCropPic 是否自动跳转裁剪
     * @return AlbumBuilder
     */
    public AlbumBuilder setAutoCropPic(boolean autoToCropPic) {
        Setting.autoToCropPic = autoToCropPic;
        return AlbumBuilder.this;
    }
     ...
     * @return AlbumBuilder
     */
    public AlbumBuilder setPicShape(PicShape picShape) {
        Setting.picShape = picShape;
        return AlbumBuilder.this;
    }
     ...
     * 设置裁剪的图片的长度和宽度
     *
     * @param cropWidth  裁剪的图片的长度
     * @param cropHeight 裁剪的图片的宽度
     * @return AlbumBuilder
     */
    public AlbumBuilder setPicCropWhAndHt(int cropWidth, int cropHeight) {
        Setting.cropWidth = cropWidth;
        Setting.cropHeight = cropHeight;
        return AlbumBuilder.this;
    }
