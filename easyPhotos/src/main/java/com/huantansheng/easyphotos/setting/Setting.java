...
public class Setting {
    ...
    public static int cropWidth = 720;
    public static int cropHeight = 720;
    ...
    public static boolean showPuzzleMenu = false;
    public static boolean showEditMenu = true;// 是否编辑按钮
    ...
    public static PicShape picShape;
    public static boolean autoToCropPic;
